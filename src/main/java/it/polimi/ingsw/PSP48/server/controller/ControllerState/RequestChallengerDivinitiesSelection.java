...
/**
 * State in which the controller request the challenger to select the available divinities
 */
public class RequestChallengerDivinitiesSelection implements GameControllerState {
    /**
