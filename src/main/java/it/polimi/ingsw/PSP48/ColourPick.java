...
public class ColourPick implements Status
{
     ...
     * @param name is the name of the player that has picked the colour
    ...
    public Status handleRequest(Colour pickedColour, String name, GameData gameData, DivinityChoice divinityChoice)
    {
        ...
        gameData.getPlayer((name)).setColour(pickedColour); //settiamo il colore scelto all'interno del player che lo ha selezionato
